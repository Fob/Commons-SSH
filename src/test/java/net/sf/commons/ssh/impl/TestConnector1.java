 ...
 * @since 2.0
 */
@SupportedFeatures({Feature.SESSION_SHELL, Feature.SYNCHRONOUS, Feature.AUTH_CREDENTIALS, Feature.ERROR_STREAM})
public class TestConnector1 implements Connector {

    public TestConnector1(Properties properties) {
    }
