...
public class PipedInputStream extends InputStream {
    ...
    private String closedByReaderMessage = "Pipe closed by reader";


    private String closedByWriterMessage = "Pipe closed by writer";
    ...
    private void checkStateForReceive() throws IOException {
        ...
        if (closedByReader) {
            throw new IOException(closedByReaderMessage);
        }
        if (closedByWriter) {
            throw new IOException(closedByWriterMessage);
        }
}
    ...
    public void setClosedByReaderMessage(String closedByReaderMessage) {
        this.closedByReaderMessage = closedByReaderMessage;
    }

    public void setClosedByWriterMessage(String closedByWriterMessage) {
        this.closedByWriterMessage = closedByWriterMessage;
    }
