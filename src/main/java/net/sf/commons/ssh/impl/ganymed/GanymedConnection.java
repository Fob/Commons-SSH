...
public class GanymedConnection extends AbstractConnection {
    ...
    /**
     * @see main.java.net.sf.commons.ssh.connection.Connection#getHostKey()
     */
    @Override
    ...
    /**
     * @see main.java.net.sf.commons.ssh.connection.Connection#isConnected()
     */
    @Override
    ...
    /**
     * @see main.java.net.sf.commons.ssh.connection.Connection#isAuthenticated()
     */
    @Override
    ...
    /**
     * @see main.java.net.sf.commons.ssh.connection.Connection#createShellSession()
     */
    @Override
    ...
    /**
     * @see main.java.net.sf.commons.ssh.connection.Connection#createExecSession()
     */
    @Override
    ...
    /**
     * @see main.java.net.sf.commons.ssh.connection.Connection#createSFTPSession()
     */
    @Override
