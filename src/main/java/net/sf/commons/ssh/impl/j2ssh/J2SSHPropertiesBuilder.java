...
public class J2SSHPropertiesBuilder
{
	public static class Connection extends PropertiesBuilder
	{
		...
		public static final String PROPERTY_KEX_TRANSFER_LIMIT = "java.impl.j2ssh.transferLimit";
		@PropertyType(Boolean.class)
		public static final String PROPERTY_DEFAULT_FORWARDING = "java.impl.j2ssh.defaultForwarding";
