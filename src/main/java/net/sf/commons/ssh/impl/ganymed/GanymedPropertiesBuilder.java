...
public class GanymedPropertiesBuilder
{
	public static class Connection extends PropertiesBuilder
	{
		...
		public static final String PROPERTY_TCP_NO_DELAY = "java.impl.ganymed.tcpNoDelay";
		@PropertyType(SecureRandom.class)
		public static final String PROPERTY_RANDOM = "java.impl.ganymed.secureRandom";
