...
public class GanymedShellSession extends AbstractSession implements ShellSession 
{
	...
	/**
	 * @see main.java.net.sf.commons.ssh.session.Session#isOpened()
	 */
	@Override
	...
	/**
	 * @see ShellSession#getInputStream()
	 */
	@Override
	...
	/**
	 * @see ShellSession#getOutputStream()
	 */
	@Override
	...
	/**
	 * @see ShellSession#getErrorStream()
	 */
	@Override
