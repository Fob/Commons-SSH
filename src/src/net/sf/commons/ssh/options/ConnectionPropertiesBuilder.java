...
public class ConnectionPropertiesBuilder extends PropertiesBuilder
{
    ...
    public ConnectionPropertiesBuilder(ConfigurableProperties options)
    {
        super(options);
    }
    ...
    public static int getKexTimeout(ConfigurableProperties options)
    {
        return (Integer) options.getProperty(KEY_KEX_TIMEOUT);
    }


    public static int getPort(ConfigurableProperties options)
    {
        return (Integer) options.getProperty(KEY_PORT);
    }


    public static int getSoTimeout(ConfigurableProperties options)
    {
        return (Integer) options.getProperty(KEY_SOCKET_TIMEOUT);
    }

    public static int getConnectTimeout(ConfigurableProperties options)
    {
        return (Integer) options.getProperty(KEY_CONNECT_TIMEOUT);
    }

    public static boolean isSendIgnore(ConfigurableProperties options)
    {
        return (Boolean) options.getProperty(KEY_SEND_IGNORE);
    }


    public static void setKexTimeout(ConfigurableProperties options, int kexTimeout)
    {
        options.setProperty(KEY_KEX_TIMEOUT, kexTimeout);
    }


    public static void setPort(ConfigurableProperties options, int port)
    {
        options.setProperty(KEY_PORT, port);
    }


    public static void setSendIgnore(ConfigurableProperties options, boolean sendIgnore)
    {
        options.setProperty(KEY_SEND_IGNORE, sendIgnore);
    }


    public static void setSoTimeout(ConfigurableProperties options, int soTimeout)
    {
        options.setProperty(KEY_SOCKET_TIMEOUT, soTimeout);
    }


    public static void setConnectTimeout(ConfigurableProperties options, int connectTimeout)
    {
        options.setProperty(KEY_CONNECT_TIMEOUT, connectTimeout);
    }
